...
export default function Profile_normal() {
    ...
    const {reciever} = useSelector(state => state.chat);
            ...
            <div className="w-[400px]">
                ...
                <div className="overflow-y-scroll bg-[#EFF1F4] y_scroll">
                    <div className="p-6 bg-white shadow-sm">
                        <div className="h-[200px] w-[200px] rounded-full bg-cover bg-center m-auto" style={{ backgroundImage: `url(${reciever?.dp})` }}></div>
                        <p className="text-center pt-5 text-[24px] text-[#3b4a54] capitalize">{String(reciever?.name)}</p>
                        <p className="text-center text-[16px] text-[#667781]">+91 {reciever?.phone}</p>
                    </div>
                    ...
                    <div className="mt-3 bg-white">
                        ...
                        <div className="flex items-center h-[58px] px-[30px] cursor-pointer hover:bg-[#ececec] hover:transition-all" title="Block">
                            ...
                            <p className="text-[#ea0038] text-[17px]">Block {reciever?.name}</p>
                        </div>
                        <div className="flex items-center h-[58px] px-[30px] cursor-pointer hover:bg-[#ececec] hover:transition-all" title="Report">
                            ...
                            <p className="text-[#ea0038] text-[17px]">Report {reciever?.name}</p>
                        </div>
